...
export function createFloor(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D) {
    ctx.beginPath()
...
export function createMountains(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D, numberOfMountains: number, offsetX: number, endX: number, height: number, color: string | CanvasGradient) {
